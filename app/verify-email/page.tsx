    ...
    return (
      <AuthLayout title="Email verified!" subtitle="Your email has been verified successfully.">
        <div className="space-y-6">
          ...
          <button
            onClick={() => router.push("/")}
            className="flex h-12 w-full items-center justify-center gap-2 rounded-xl bg-[#113680] text-sm font-semibold text-white shadow-md shadow-[#113680]/20 transition-all duration-300 hover:bg-[#0d2960] hover:shadow-lg hover:scale-[1.01]"
          >
            Go to Dashboard
      ...
      <div className="space-y-6">
        ...
        <div className="flex justify-center">
          <div className="relative">
            ...
            {/* Animated dots */}
            <div className="absolute -top-2 -right-2 h-3 w-3 rounded-full bg-[#113680] animate-bounce" style={{ animationDelay: "0ms" }} />
            <div className="absolute -top-1 right-4 h-2 w-2 rounded-full bg-[#113680]/60 animate-bounce" style={{ animationDelay: "200ms" }} />
            <div className="absolute top-3 -right-3 h-2 w-2 rounded-full bg-[#113680]/40 animate-bounce" style={{ animationDelay: "400ms" }} />
          </div>
        </div>
        ...
        <div className="rounded-xl border border-[#113680]/10 bg-[#113680]/5 p-4 space-y-3">
          <p className="text-xs text-[#113680] font-semibold">
            ✨ Demo: Click below to simulate clicking the verification link from your email
          </p>
          <button
            onClick={handleVerify}
            disabled={isVerifying}
            className="flex h-11 w-full items-center justify-center gap-2 rounded-xl bg-[#113680] text-sm font-semibold text-white shadow-md shadow-[#113680]/20 transition-all duration-300 hover:bg-[#0d2960] hover:shadow-lg hover:scale-[1.01] disabled:opacity-60"
          >
            {isVerifying ? (
              <>
        ...
        <div className="flex items-center justify-center gap-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 text-sm font-semibold text-[#fe4443] transition-colors hover:underline disabled:opacity-60"
          >
            {isResending ? (
